...
if __name__ == "__main__": 
    ...
    Forces_2 = ReactionForces(Rx= 1066.4, Ry= 107.5, Rz=221.93,angle_normal_x= 0, angle_normal_y= 0, angle_normal_z= 0)
    Forces_3 = ReactionForces(Rx= -662.83, Ry= 220.21, Rz=-85.629,angle_normal_x= 0, angle_normal_y= 0, angle_normal_z= 0)
    Forces_4 = ReactionForces(Rx= 960.78, Ry= 837.15, Rz=-197.7,angle_normal_x= 0, angle_normal_y= 0, angle_normal_z= 45)
